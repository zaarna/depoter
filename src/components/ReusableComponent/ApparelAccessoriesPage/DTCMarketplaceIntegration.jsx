...
const crossBorderCards = [
  ...
  },
  {
    ...
    answer:
      "Hassle-free inbound preparation for Amazon and Noon marketplaces. ",
  },
  {
    question: "Automated Order Sync",
    answer:
      "Instant stock updates across all connected platforms to prevent accidental overselling.",
  },
  {
    question: "Secure APIs",
    answer:
      "Custom-built website integration via secure APIs for smooth, manual-free data flow.",
  },
  {
    question: "Custom Packaging Support",
    answer:
      "Insert personalized thank-you cards, custom tissue paper, or branded boxes to enhance your brand experience.",
  },
];
...
export default function DTCMarketplaceIntegration() {
  ...
  return (
    <div className="py-8 md:py-16 bg-[#978050] relative overflow-hidden">
      <div className="absolute hidden md:block bottom-0">
        <img src="/marketplace-integration-logo.svg" alt="" />
      </div>
      <div className="container">
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-16 items-start mb-6 md:mb-12">
