...
import TimelineCard from "../B2b_Sections/TimeLineCard";

function CompleteProductRegistration(sectionKey = []) {
    const tc =
        titleContentConfig[sectionKey] || titleContentConfig["completeproductregistration"];
    ...
    return (
        <section className="py-8 md:py-16 relative overflow-hidden bg-[#ffffff]">
...
export default CompleteProductRegistration;
